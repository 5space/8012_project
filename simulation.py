...
class Simulation:
    ...
    def step_sieuler(self, dt):
        ...
        for i in range(self.n):
            ...
            """
            ^^^ This line is a hacky fix that I put in to fix floating point errors.
            Basically, the order in which I was summing net acceleration caused some symmetry issues
            which derailed the whole simulation after about 20 seconds.
            So now after every step it truncates the floats.
            """
        self.bodies = new
        self.t += dt
